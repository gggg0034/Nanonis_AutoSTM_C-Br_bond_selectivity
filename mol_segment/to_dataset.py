...
# 图像和掩码的文件夹路径
image_folder = 'D:/桌面/project/atomai/dataset/augmented_images1'
mask_folder = 'D:/桌面/project/atomai/dataset/augmented_masks'
...
# 保存数据
np.save('D:/桌面/project/atomai/dataset/train_images1.npy', images_train)
np.save('D:/桌面/project/atomai/dataset/train_masks1.npy', masks_train)
np.save('D:/桌面/project/atomai/dataset/test_images1.npy', images_test)
np.save('D:/桌面/project/atomai/dataset/test_masks1.npy', masks_test)
