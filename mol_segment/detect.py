...
def segmented_image(img, output_folder, model_path='./mol_segment/unet_modelsingle.pth'):
    ...
    return  thresholded_mask, nemo_point, coverage

if __name__ == '__main__':

    # 示例使用
    # image_path = './mol_segment/003.png'
    # output_folder = './mol_segment/results1'
    # model_path = './mol_segment/unet_model-zzw-Ni.pth'
    image_path = './mol_segment/058_test/444_15.png'
    output_folder = './mol_segment/results1'
    model_path = './mol_segment/unet_model-zzw-Ni_V2.pth'
