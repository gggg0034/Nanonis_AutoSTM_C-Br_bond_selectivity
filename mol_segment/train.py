...
# 加载数据集
train_images = np.load('D:/桌面/project/atomai/dataset/train_images1.npy')
train_masks = np.load('D:/桌面/project/atomai/dataset/train_masks1.npy')
val_images = np.load('D:/桌面/project/atomai/dataset/test_images1.npy')
val_masks = np.load('D:/桌面/project/atomai/dataset/test_masks1.npy')
