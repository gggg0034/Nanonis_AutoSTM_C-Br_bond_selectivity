...
try:
    ...
    from ..utils.general import (increment_path, make_divisible, non_max_suppression,
                            non_max_suppression_export, save_one_box,
                            scale_coords, xyxy2xywh)
    from ..utils.plots import colors, plot_one_box
    from ..utils.torch_utils import time_synchronized
except:
    from keypoint.utils.datasets import letterbox
    from keypoint.utils.general import (increment_path, make_divisible, non_max_suppression,
                            non_max_suppression_export, save_one_box,
                            scale_coords, xyxy2xywh)
    from keypoint.utils.plots import colors, plot_one_box
    from keypoint.utils.torch_utils import time_synchronized
