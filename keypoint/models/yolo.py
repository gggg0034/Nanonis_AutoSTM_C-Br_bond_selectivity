...
try:
    ...
    from keypoint.models.common import *
    from keypoint.models.experimental import *
    from keypoint.utils.autoanchor import check_anchor_order
    from keypoint.utils.general import make_divisible, check_file, set_logging
    from keypoint.utils.torch_utils import time_synchronized, fuse_conv_and_bn, model_info, scale_img, initialize_weights, \
        select_device, copy_attr
